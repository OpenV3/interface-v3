...
export const V3_CORE_FACTORY_ADDRESSES: AddressMap = {
  ...
  [ChainId.INK_SEPOLIA]: CHAIN_TO_ADDRESSES_MAP[ChainId.INK_SEPOLIA].v3CoreFactoryAddress,
...
export const QUOTER_V2_ADDRESSES: AddressMap = {
  ...
  [ChainId.INK_SEPOLIA]: CHAIN_TO_ADDRESSES_MAP[ChainId.INK_SEPOLIA].quoterAddress,
  // TODO: Gnosis + Moonbeam contracts to be deployed
}
...
export const MIXED_ROUTE_QUOTER_V1_ADDRESSES: AddressMap = {
  ...
  [ChainId.INK_SEPOLIA]: CHAIN_TO_ADDRESSES_MAP[ChainId.INK_SEPOLIA].mixedRouteQuoterV1Address,
}
...
export const UNISWAP_MULTICALL_ADDRESSES: AddressMap = {
  ...
  [ChainId.INK_SEPOLIA]: CHAIN_TO_ADDRESSES_MAP[ChainId.INK_SEPOLIA].multicallAddress,
  // TODO: Gnosis + Moonbeam contracts to be deployed
}
