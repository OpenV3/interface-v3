...
import { CUSD_CELO, CUSD_CELO_ALFAJORES, USDC_MAINNET, USDT_INK_SEPOLIA } from '../constants/tokens'
...
export const STABLECOIN_AMOUNT_OUT: { [key in SupportedInterfaceChain]: CurrencyAmount<Token> } = {
  ...
  [ChainId.INK_SEPOLIA]: CurrencyAmount.fromRawAmount(USDT_INK_SEPOLIA, 100e18),
}
