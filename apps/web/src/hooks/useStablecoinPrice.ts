...
import { CUSD_CELO, CUSD_CELO_ALFAJORES, USDC_INK_SEPOLIA, USDC_MAINNET } from '../constants/tokens'
...
export const STABLECOIN_AMOUNT_OUT: { [key in SupportedInterfaceChain]: CurrencyAmount<Token> } = {
  ...
  [ChainId.INK_SEPOLIA]: CurrencyAmount.fromRawAmount(USDC_INK_SEPOLIA, 100e6),
}
